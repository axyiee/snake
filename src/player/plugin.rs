...
use bevy::{prelude::{Plugin, SystemSet, ParallelSystemDescriptorCoercion, Commands, ResMut, Assets, Mesh}, pbr::StandardMaterial};
...
impl Plugin for PlayerPlugin {
    fn build(&self, app: &mut bevy::prelude::App) {
        app.add_plugin(PlayerInputPlugin)
         .add_system_set(SystemSet::on_enter(GameplayState::Playing).with_system(spawn_player.label(SpawnPlayer)));
    }
}
